    ...
    <div class="section no-pad-bot">
        <div class="container">
            <div class="row">
                ...
                ?>
                <h4>Non segui nessun evento  ¯\_(ツ)_/¯</h4>
                <?php
                    else:
                        ...
                        <div class="card sticky-action hoverable" style="height: 480px;">
                            ...
                            <div class="card-action" style="height: 10%;">
                                <form role="form" action="#" method="post">                                    
                                    <a id="removeIntrest" onclick="removeIntrest(<?php echo $evento['id']?>)" class="btn-floating btn-large waves-effect waves-light #00e676 green accent-3 right hoverable" style="margin:5px;"><i class="material-icons">cancel</i></a>
                            ...
                            <div class="card-reveal">
                                ...
                                <p class="left-align"><strong>Terminerà:</strong> <?php echo $evento["data_fine"]; ?> alle <?php echo $evento["ora_fine"]; ?></p>
