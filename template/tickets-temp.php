    ...
    <div class="section no-pad-bot">
        <div class="container">
            <div class="row">
                ...
                ?>
                <h4>Non hai ancora acquistato nessun biglietto  ¯\_(ツ)_/¯</h4>
                <?php
                    else:
                    ...
                    <div id="<?php echo $evento['id']?>" class="col s12 m6 l4 cards-container active">
                        <div class="card sticky-action hoverable" style="height: 480px;">
                            ...
                            <div class="card-reveal">
                                ...
                                <br>
                                <p class="left-align"><strong>Quantità Acquistata:</strong> <?php echo $evento["quantita"]; ?></p>
                                <p class="left-align"><strong>Timestamp Acquisto:</strong> <?php echo $evento["data_acquisto"]; ?></p>
                            </div>
                        </div>                    
                    </div>
                <?php
